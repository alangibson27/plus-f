...
public class OpCbGroup implements Operation {

    private final Processor processor;
    private final int[] memory;
    private final Operation[] operations = new Operation[0x100];

    public OpCbGroup(final Processor processor, final int[] memory) {
...
//            operations[0x23] = new OpSlaReg(processor, "e");
//            operations[0x24] = new OpSlaReg(processor, "h");
//            operations[0x25] = new OpSlaReg(processor, "l");
//            operations[0x26] = new OpSlaHlIndirect(processor, memory);
//            operations[0x27] = new OpSlaReg(processor, "a");
//            operations[0x28] = new OpSraReg(processor, "b");
//            operations[0x29] = new OpSraReg(processor, "c");
//            operations[0x2a] = new OpSraReg(processor, "d");
//            operations[0x2b] = new OpSraReg(processor, "e");
//            operations[0x2c] = new OpSraReg(processor, "h");
//            operations[0x2d] = new OpSraReg(processor, "l");
//            operations[0x2e] = new OpSraHlIndirect(processor, memory);
//            operations[0x2f] = new OpSraReg(processor, "a");
//
//            operations[0x30] = new OpSllReg(processor, "b");
//            operations[0x31] = new OpSllReg(processor, "c");
//            operations[0x32] = new OpSllReg(processor, "d");
//            operations[0x33] = new OpSllReg(processor, "e");
//            operations[0x34] = new OpSllReg(processor, "h");
//            operations[0x35] = new OpSllReg(processor, "l");
//            operations[0x36] = new OpSllHlIndirect(processor, memory);
//            operations[0x37] = new OpSllReg(processor, "a");
//            operations[0x38] = new OpSrlReg(processor, "b");
//            operations[0x39] = new OpSrlReg(processor, "c");
//            operations[0x3a] = new OpSrlReg(processor, "d");
//            operations[0x3b] = new OpSrlReg(processor, "e");
//            operations[0x3c] = new OpSrlReg(processor, "h");
//            operations[0x3d] = new OpSrlReg(processor, "l");
//            operations[0x3e] = new OpSrlHlIndirect(processor, memory);
//            operations[0x3f] = new OpSrlReg(processor, "a");
//
